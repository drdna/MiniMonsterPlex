...
for file in fileList:
	...
	os.system(f'bcftools mpileup --threads 2 -d 100000 -R MonsterPlexRegionsFileSuperCont.txt --annotate FORMAT/AD -f index/70-15.fasta.fasta OutNew/{fileNum}hits.bam >> OutNew/{fileNum}.vcf')
